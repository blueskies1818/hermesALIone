...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Browser Control (cross-platform) — multi-paragraph block.
    if "browser_control" in agent.valid_tool_names:
        from agent.prompt_builder import BROWSER_CONTROL_GUIDANCE
        stable_parts.append(BROWSER_CONTROL_GUIDANCE)
