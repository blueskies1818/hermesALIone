...
_HERMES_CORE_TOOLS = [
    ...
    # Cross-platform browser control + app launching (Playwright)
    "browser_control",
    # Browser automation
...
TOOLSETS = {
    ...
    "browser_control": {
        "description": (
            "Cross-platform browser automation via Playwright and system app "
            "launching. Launch Chromium/Firefox, navigate, click, type, scroll, "
            "screenshot. Works on Linux, macOS, and Windows."
        ),
