...
CONFIGURABLE_TOOLSETS = [
    ...
    ("browser_control",  "🌐 Browser Control",           "cross-platform browser automation + app launch"),
]
...
TOOL_CATEGORIES = {
    ...
    "browser_control": {
        ...
        "providers": [
            {
                "name": "Playwright (cross-platform)",
                "badge": "★ recommended · free · local",
                "tag": (
                    "Launch and control Chromium/Firefox browsers. "
                    "Navigate, click, type, scroll, screenshot, and "
                    "launch system apps. Works on Linux, macOS, and Windows."
                ),
                "env_vars": [],
                "post_setup": "playwright_browsers",
            },
        ],
    },
}
...
def _toolset_needs_configuration_prompt(ts_key: str, config: dict) -> bool:
    ...
    # check that hasn't been satisfied, force the configuration flow so `_configure_provider`
